          ...
          java.sql.Connection c=null;
            fname=(String)session.getAttribute("admin");
             ...
             c=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","2566");
              ...
              ResultSet rs=st.executeQuery("select * from customers  where username like '"+u+"'");
//              out.println(fname);
...
<script type="text/javascript"> 
    ...
    function search()
    {
        ...
        if(usern=="" || usern==null)
        {
        document.getElementById('hii').innerHTML="Not Found"; 

        // window.location.replace("getCustomersDetails.jsp?");
        }
        else{
